...
class DepartamentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departament" do
    assert_difference('Departament.count') do
      post departaments_url, params: { departament: { company_id: @departament.company_id, name: @departament.name } }
    end
  ...
  test "should update departament" do
    patch departament_url(@departament), params: { departament: { company_id: @departament.company_id, name: @departament.name } }
